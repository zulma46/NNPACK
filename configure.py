    ...
    with build.options(source_dir="src", macros=macros,
        ...
        if options.target.is_windows:
            reference_fft_objects = [
                build.cc("ref/fft/aos.cpp"),
                build.cc("ref/fft/soa.cpp"),
                build.cc("ref/fft/forward-real.cpp"),
                build.cc("ref/fft/forward-dualreal.cpp"),
                build.cc("ref/fft/inverse-real.cpp"),
                build.cc("ref/fft/inverse-dualreal.cpp"),
            ]
        else:
            reference_fft_objects = [
        ...
        if backend == "x86_64":
            if options.target.is_windows:
                arch_fft_stub_objects = [
                    ...
                    build.cc("psimd/fft-soa.cpp"),
                    build.cc("psimd/fft-dualreal.cpp"),
                    build.cc("psimd/ifft-dualreal.cpp"),
                    build.cc("psimd/fft-real.cpp"),
                    build.cc("psimd/ifft-real.cpp"),
                ]
