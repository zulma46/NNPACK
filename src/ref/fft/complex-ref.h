...
inline static void butterflyfc(std::complex<float>* a, std::complex<float>* b)
{
	...
	const std::complex<float> new_b = *a - *b;
	*a = new_a;
	*b = new_b;
}

inline static void swapfc(std::complex<float>* a, std::complex<float>* b) 
{
	const std::complex<float> new_a = *b;
	const std::complex<float> new_b = *a;
	*a = new_a;
	*b = new_b;
}

inline static void fft2fc(std::complex<float>* w0, std::complex<float>* w1)
{
	/* FFT2: butterfly */
	butterflyfc(w0, w1);
}

inline static void ifft2fc(std::complex<float>* W0,	std::complex<float>* W1)
{
	/* IFFT2: butterfly */
	butterflyfc(W0, W1);
...
inline static void fft4fc(std::complex<float>* w0, std::complex<float>* w1,	std::complex<float>* w2, std::complex<float>* w3)
{
	/* FFT4: butterfly */
	butterflyfc(w0, w2);
	butterflyfc(w1, w3);
...
inline static void fft8fc(
	...
	std::complex<float>* w4,
	std::complex<float>* w5,
	std::complex<float>* w6,
	std::complex<float>* w7)
{
	/* FFT8: butterfly */
	butterflyfc(w0, w4);
	butterflyfc(w1, w5);
...
inline static void fft16fc(
	...
	std::complex<float>* w6,
	std::complex<float>* w7,
	std::complex<float>* w8,
	std::complex<float>* w9,
	std::complex<float>* w10,
	std::complex<float>* w11,
	std::complex<float>* w12,
	std::complex<float>* w13,
	std::complex<float>* w14,
	std::complex<float>* w15)
{
	/* FFT16: butterfly */
	butterflyfc(w0, w8);
	butterflyfc(w1, w9);
...
inline static void fft32fc(
	...
	std::complex<float>* w14,
	std::complex<float>* w15,
	std::complex<float>* w16,
	std::complex<float>* w17,
	std::complex<float>* w18,
	std::complex<float>* w19,
	std::complex<float>* w20,
	std::complex<float>* w21,
	std::complex<float>* w22,
	std::complex<float>* w23,
	std::complex<float>* w24,
	std::complex<float>* w25,
	std::complex<float>* w26,
	std::complex<float>* w27,
	std::complex<float>* w28,
	std::complex<float>* w29,
	std::complex<float>* w30,
	std::complex<float>* w31)
{
	/* FFT32: butterfly */
	butterflyfc(w0,  w16);
	butterflyfc(w1,  w17);
